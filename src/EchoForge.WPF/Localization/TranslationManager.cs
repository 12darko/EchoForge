...
public class TranslationDictionary : System.ComponentModel.INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["en"] = new()
        {
            ...
            // Sidebar Panels (Clipchamp)
            ["Ed_SideMedia"] = "Media",
            ["Ed_SideEffects"] = "Effects",
            ["Ed_SideFilters"] = "Filters",
            ["Ed_SideTransitions"] = "Transitions",
            ["Ed_SideAudio"] = "Audio",
            ["Ed_SideSpeed"] = "Speed",
            ["Ed_ProjectImages"] = "Project Images",
            ["Ed_SelectSceneApply"] = "Select a scene, then click an effect to apply.",
            ["Ed_VisualFX"] = "Visual Effects",
            ["Ed_ColorFilters"] = "Color Filters",
            ["Ed_SceneTransitions"] = "Scene Transitions",
            ["Ed_AudioSettings"] = "Audio Settings",
            ["Ed_MusicVol"] = "Music Volume",
            ["Ed_IntroFade"] = "Intro Fade",
            ["Ed_OutroFade"] = "Outro Fade",
            ["Ed_SpeedControl"] = "Speed Control",
            ["Ed_SpeedPresets"] = "Presets",
            ["Ed_AdjustColors"] = "Adjust Colors",
            ["Ed_Brightness"] = "Brightness",
            ["Ed_Contrast"] = "Contrast",
            ["Ed_Saturation"] = "Saturation",
            ["Ed_Temperature"] = "Temperature",
            ["Ed_Tint"] = "Tint",
            ["Ed_ResetAll"] = "Reset All",
            ["Ed_Properties"] = "Properties",
            ["Ed_SelectScene"] = "Select a scene to edit its properties",
            ["Ed_ActiveFilter"] = "Active Filter",
            ["Ed_ActiveTransition"] = "Active Transition",
            ["Ed_ImagePromptLabel"] = "Image Prompt",
            ["Ed_RegenerateBtn"] = "Regenerate Image",
            ["Ed_SaveChanges"] = "Save Changes",
        ...
        ["tr"] = new()
        {
            ...
            // Sidebar Panels (Clipchamp)
            ["Ed_SideMedia"] = "Medya",
            ["Ed_SideEffects"] = "Efektler",
            ["Ed_SideFilters"] = "Filtreler",
            ["Ed_SideTransitions"] = "Geçişler",
            ["Ed_SideAudio"] = "Ses",
            ["Ed_SideSpeed"] = "Hız",
            ["Ed_ProjectImages"] = "Proje Görselleri",
            ["Ed_SelectSceneApply"] = "Bir sahne seçin, ardından uygulamak için bir efekte tıklayın.",
            ["Ed_VisualFX"] = "Görsel Efektler",
            ["Ed_ColorFilters"] = "Renk Filtreleri",
            ["Ed_SceneTransitions"] = "Sahne Geçişleri",
            ["Ed_AudioSettings"] = "Ses Ayarları",
            ["Ed_MusicVol"] = "Müzik Sesi",
            ["Ed_IntroFade"] = "Giriş Geçişi",
            ["Ed_OutroFade"] = "Çıkış Geçişi",
            ["Ed_SpeedControl"] = "Hız Kontrolü",
            ["Ed_SpeedPresets"] = "Hazır Ayarlar",
            ["Ed_AdjustColors"] = "Renk Ayarları",
            ["Ed_Brightness"] = "Parlaklık",
            ["Ed_Contrast"] = "Kontrast",
            ["Ed_Saturation"] = "Doygunluk",
            ["Ed_Temperature"] = "Sıcaklık",
            ["Ed_Tint"] = "Ton",
            ["Ed_ResetAll"] = "Tümünü Sıfırla",
            ["Ed_Properties"] = "Özellikler",
            ["Ed_SelectScene"] = "Özelliklerini düzenlemek için bir sahne seçin",
            ["Ed_ActiveFilter"] = "Aktif Filtre",
            ["Ed_ActiveTransition"] = "Aktif Geçiş",
            ["Ed_ImagePromptLabel"] = "Görsel İstemi",
            ["Ed_RegenerateBtn"] = "Görseli Yeniden Oluştur",
            ["Ed_SaveChanges"] = "Değişiklikleri Kaydet",
